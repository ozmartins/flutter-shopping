...
class AnimatedInput extends StatelessWidget {
  ...
  AnimatedInput(this.controller, {Key? key})
      : containerOpacityAnim = Tween(begin: 0.0, end: 1.0).animate(
            CurvedAnimation(parent: controller, curve: Interval(0.7, 0.9))),
        containerSizeAnim = Tween(begin: 60.0, end: 280.0).animate(
            CurvedAnimation(parent: controller, curve: Interval(0.2, 0.3))),
        ...
        containerColorAnim =
            ColorTween(begin: Colors.white.withOpacity(0), end: Colors.black12)
                .animate(CurvedAnimation(
                    parent: controller, curve: Interval(0.0, 0.25))),
        super(key: key);
